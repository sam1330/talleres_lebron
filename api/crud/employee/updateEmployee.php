<?php include "../../main/conexion.php";
    ...
    $query = $con->prepare("UPDATE clientes SET nombre=?, identificacion=?, telefono=?, email=?, direccion=?, tipo=? WHERE id=?");
    $query->bind_param("ssssssi", $nombre, $identificacion, $telefono, $email, $direccion, $tipo, $id);
