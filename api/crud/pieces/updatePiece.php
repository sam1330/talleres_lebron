<?php include "../../main/conexion.php";
    ...
    $query = $con->prepare("UPDATE repuesto SET detalle=?, existencia=?, reorden=?, id_cat=?, prec_com=?, prec_ven=?, id_prov=?, id_alm=? WHERE cod_rep=?");
    $query->bind_param("siiiiiiii", $detalle, $existencia, $reorden, $id_cat, $prec_com, $prec_ven, $id_prov, $id_alm, $cod_rep);
