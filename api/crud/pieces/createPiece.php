<?php include "../../main/conexion.php";
    ...
    $query = $con->prepare("INSERT INTO repuesto (detalle, existencia, reorden, id_cat, prec_com, prec_ven, id_prov, id_alm) VALUES (?,?,?,?,?,?,?,?)");
    $query->bind_param("siiiiiii", $detalle, $existencia, $reorden, $id_cat, $prec_com, $prec_ven, $id_prov, $id_alm);
